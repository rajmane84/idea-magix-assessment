...
import { paymentQrLimiter, createConsultationLimiter } from "../middleware/rateLimit";
...
router.post("/", requireAuth("patient"), requireVerified(), createConsultationLimiter, createConsultation);
